...
//   author: string
//   body: string
//   dateCreated: string // Keep as string, will be parsed by new Date()
//   index: number
//   participantSid?: string // Optional participant SID
// }
...
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           body: JSON.stringify({ body: messageBody, author: messageAuthor }),
//         }
//       )
//       const data = await response.json()
//       if (data.success) {
...
//         // Ensure messages are sorted correctly by date
...
//                     borderRadius: "4px",
//                     backgroundColor:
//                       msg.author === messageAuthor ? "#d1e7dd" : "#f8f9fa",
//                     border: "1px solid #ccc",
//                   }}
//                 >
