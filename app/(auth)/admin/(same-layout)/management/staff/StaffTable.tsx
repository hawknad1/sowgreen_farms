...
import { columns } from "@/app/(auth)/admin/(same-layout)/management/staff/columns" // Corrected import for the columns

import { DispatchRider, Staff } from "@/types"
import DataSkeletons from "@/components/skeletons/DataSkeletons"
import AddRiderDialog from "./AddStaffDialog"
...
const StaffTable = ({ loading, data }: OrdersProps) => {
