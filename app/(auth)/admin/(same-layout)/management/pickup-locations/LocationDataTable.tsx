...
import { columns } from "@/app/(auth)/admin/(same-layout)/management/pickup-locations/columns" // Corrected import for the columns
...
const LocationDataTable = ({ loading, data }: LocationProps) => {
