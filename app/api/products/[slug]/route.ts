...
// import { applyTaxToProduct } from "@/lib/serviceCharge"
...
export async function GET(
  ...
  try {
    ...
    const productsWithTax = await TaxService.applyTaxToProduct(
      product as unknown as Product
    )

    // const appliedTax = applyTaxToProduct(product as unknown as Product)
