...
const ProductDetailPage = ({ params }: { params: { slug: string } }) => {
  ...
  const hasImages = product.images && product.images.length > 0
  const isOutOfStock =
    product.isInStock === "out-of-stock" || product.quantity <= 0
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="w-full sm:w-[55%] lg:w-[60%] space-y-4 sm:space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              {isLowStock && (
                <span className="text-xs sm:text-sm font-medium text-orange-600 bg-orange-50 px-2 py-1 rounded">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center border rounded-md">
                ...
                <Button
                  ...
                  disabled={localQuantity >= product.quantity || isOutOfStock}
                >
                  +
                </Button>
              </div>
