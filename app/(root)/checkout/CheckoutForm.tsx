...
//   // Handle custom city input change - prevent deletion when Unknown Location is selected
//   const handleCustomCityChange = (value: string) => {
//     setCustomCity(value)
//     console.log(value, "value")
//     // If user tries to clear the field while Unknown Location is selected, prevent it
//     if (selectedCity === "Unknown Location" && value.trim() === "") {
//       // Optional: You can show a toast message here
//       console.log("City name is required for unknown locations")
//       // Don't update the state if trying to clear
//       return
//     }
//     setCustomCity(value)
//   }
...
//                                 City name is required for unknown locations
//                               </p>
//                             )}
//                           </FormItem>
//                         </motion.div>
