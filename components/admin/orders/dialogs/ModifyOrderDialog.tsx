...
//                     <div className="flex justify-between text-black font-semibold mb-3 flex-wrap gap-2">
...
//                           }
//                           className="w-20 h-8 inline-block ml-2"
//                         />
//                       </p>
//                       <p className="text-xs md:text-sm">
...
//               ) : (
//                 <>
//                   <div className="lg:col-span-3 border-r p-4 overflow-y-auto">
...
const ModifyOrderDialog = ({ order }: { order: Order }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-4xl h-[90dvh] sm:h-[80vh] flex flex-col p-0">
        {isReadOnly ? (
          <div className="p-6">
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <h3 className="font-medium text-red-800">
